...
public class PartTime extends Employee{
    ...
    /*public UserType.PartTime(String first_Name, String last_Name, int employee_ID, String phone_Number, String email, boolean marital_Status, String PPSN, double hours_Per_Week, String unionFees){
